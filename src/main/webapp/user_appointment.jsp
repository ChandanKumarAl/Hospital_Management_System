	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 p-5">
				<img alt="No Image Found" src="img/doctor.jpg" width="400px"
					height="530px">
			</div>
						...
						<form action="addAppointment" class="row g-3" method="post">
							...
							<div class="col-md-6">
								<label for="inputEmail4" class="form-label">Phone No</label><input
									required type="number" class="form-control" maxlength="10"
									name="phno">
							</div>
							...
							<div class="col-md-6">
								<label for="inputPassword" class="form-label">Doctor</label><select
